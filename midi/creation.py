...
class Samdasu():
    def _steps_to_seconds(self, steps, qpm):
        return steps * 60.0 / qpm / 4
    """
    ...
    def create_midi_default(self, primer_midi, output_midi):
        ...
        generator_options.generate_sections.add(
            start_time=last_end_time + self._steps_to_seconds(1, qpm),
    ...
    def create_midi_with_second(self, primer_midi, output_midi, second):
        BUNDLE_NAME = 'attention_rnn'
